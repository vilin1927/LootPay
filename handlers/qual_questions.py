...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "🔹 **Поддержка 24/7**\n\n"
        "💳 _Автоматическое зачисление от_ **100 ₽**\n"
        "_— любые РФ‑карты или СБП_\n\n"
        "---\n\n"
        "**Как это работает?**\n\n"
        "1️⃣ _Запусти бота, включи уведомления, введи Steam ID_\n"
        "2️⃣ _Выбери сумму и оплати через СБП_\n"
        "3️⃣ _Получи уведомление о зачислении_ 🎉\n\n"
        "---\n\n"

...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        "Привет, это \\*LootPay\\*\\!\n"
        "Бот для быстрого и надёжного пополнения \\_\\_Steam\\_\\_ кошелька\n\n"
        "\\*Знакомо\\? Было\\?\\*\n\n"
        ...
        "⋯⋯⋯⋯⋯⋯⋯⋯\n"
        "Пополняй \\_\\_Steam\\_\\_ за 15 минут\n"
        ...
        "— — — — — — — — —\n"
        "🔸 Как это работает\\?\n\n"
        "1️⃣ Запусти бота, включи уведомления, введи \\_\\_Steam\\_\\_ ID  \n"

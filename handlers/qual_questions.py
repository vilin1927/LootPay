...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "• **Поддержка 24/7**\n\n"
        "💳 *Автоматическое зачисление от* **100 ₽**\n"
        "*— любые РФ‑карты или СБП*\n\n"
        "---\n\n"
        "**Как это работает?**\n\n"
        "1. ▶️ *Запусти бота, включи уведомления, введи Steam ID*\n"
        "2. ▶️ *Выбери сумму и оплати через СБП*\n"
        "3. ▶️ *Получи уведомление о зачислении* 🎉\n\n"
        "---\n\n"

...
async def cmd_start(message: Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "_Всего 5 минут, и баланс в Steam пополнен..._\n"
        "А вместо этого – долгие ожидания, скрытые наценки и тревога, что средства не дойдут. Знакомо?\n\n"
        "✨ **С LootPay такого не будет.** ✨\n\n"
        "**Пополняй Steam за 15 минут** с удобной оплатой, честным курсом и без риска быть обманутым ⏱️\n\n"
        ...
        "1. ▶️ Запусти бота, разреши уведомления, пройди туториал и введи Steam ID\n\n"
        "2. ▶️ Выбери сумму (с комиссией) и оплати через СБП\n\n"
        "3. ▶️ Получи уведомление о зачислении средств\n\n"
        "Пополнить без риска и обмана вместе с LootPay! 🎮"
    )
